...
<head>
    ...
    <title>Connexion | T9el.ma</title>
    <style>
        /* Styles de base identiques à register.php */
        :root {
            --primary: #2C5D8C;
...
<body>
    ...
    <main class="login-container">
        <div class="login-card">
            ...
            <p class="login-subtitle">Accédez à votre espace client T9el.ma</p>
            ...
            <form method="POST" class="login-form">
                ...
                <p class="register-link">Pas encore de compte? <a href="register.php">Créez un compte</a></p>
            </form>
        </div>
    </main>
